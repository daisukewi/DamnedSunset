...
Contiene la declaración del componente que controla la IA de la supermente.
...
*/
	...
	protected:
		...
		/**
		Cada cuánto tiempo se ejecuta 
		*/
		int _exeTime;

		/**
		Cuenta de cuánto tiempo va ejecutado sin hacer la IA.
		*/
		int _currentExeTime;
