...
Contiene la declaración del componente que controla el comportamiento de los paneles solares.
...
*/
	...
	public:
		...
		*/
		...
		/**
		Método virtual que elige qué mensajes son aceptados.
	...
	protected:
		...
		/**
		Atributo que indica el radio de acción del panel solar.
		*/
		float _radioEnergy;
