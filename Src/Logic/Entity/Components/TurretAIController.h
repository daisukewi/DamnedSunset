/**
@file TurretAIController.h

Contiene la declaración del componente que controla la IA de las torretas.

@author Alberto Ortega
@date Julio, 2012
*/
#ifndef __Logic_TurretAIController_H
#define __Logic_TurretAIController_H
...
/**
	...
	@date Mayo, 2012
*/
	class CTurretAIController : public IComponent
	{
		DEC_FACTORY(CTurretAIController);
	public:
		...
		defecto.
		*/
		CTurretAIController() : IComponent(), _exeFrames(10), _currentExeFrames(0) {}
	...
	protected:
		...
		*/
		std::list<Logic::CEntity*> _TurretEntities;
	...
	}; // class CTurretAIController

	REG_FACTORY(CTurretAIController);

} // namespace Logic

#endif // __Logic_TurretAIController_H
