...
Contiene la declaración del componente que controla la IA de los enemigos.

@author Alberto Plaza
@date Mayo, 2012
*/
#ifndef __Logic_EnemyAIController_H
#define __Logic_EnemyAIController_H
...
/**
	...
	@date Mayo, 2012
*/
	class CEnemyAIController : public IComponent
	{
		DEC_FACTORY(CEnemyAIController);
	public:
		...
		defecto.
		*/
		CEnemyAIController() : IComponent(), _exeFrames(10), _currentExeFrames(0) {}
...
#endif // __Logic_EnemyAIController_H
