/**
@file TurretPerception.h

Contiene la declaración del componente que controla la percepción de las torretas.

@author Alberto Ortega
@date Julio, 2012
*/
#ifndef __Logic_TurretPerception_H
#define __Logic_TurretPerception_H
...
/**
	...
	@date Mayo, 2012
*/
	class CTurretPerception : public IComponent
	{
		DEC_FACTORY(CTurretPerception);
	public:
		...
		defecto.
		*/
		CTurretPerception() : IComponent(), _distanceOfView(0), _perceptionCountTime(0), _minDistance (100000), _minDistanceEntity(-1) {}
	...
	}; // class CTurretPerception

	REG_FACTORY(CTurretPerception);

} // namespace Logic

#endif // __Logic_TurretPerception_H
