...
namespace Sound{
	...
	class CServer : public Ogre::Singleton<CServer>
	   {
	public:
		...
		/**
		Actualización del manager de sonido

		@parm SceneNode de la camara
		@parm Tiempo ocurrido desde el último tick
		*/
		void                 tick(Ogre::SceneNode *listenerNode, Ogre::Real timeElapsed);
		...
		static CServer& getSingleton(void);
		static CServer* getSingletonPtr(void);
