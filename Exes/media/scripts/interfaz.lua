...
function init()
	...
	--CEGUI.WindowManager:getSingleton():getWindow("Interfaz/bPersonaje1"):subscribeEvent(CEGUI.PushButton.EventClicked, CEGUI:SubscriberSlot(GUI.CInterfazController.clickPersonaje1, self))

	--	CEGUI.WindowManager:getSingleton():getWindow("Interfaz/bPersonaje2"):subscribeEvent(CEGUI.PushButton.EventClicked, CEGUI:SubscriberSlot(GUI.CInterfazController.clickPersonaje2, self))

	--	CEGUI.WindowManager:getSingleton():getWindow("Interfaz/bPersonaje3"):subscribeEvent(CEGUI.PushButton.EventClicked, CEGUI:SubscriberSlot(GUI.CInterfazController.clickPersonaje3, self))
...
function actualizarBarraVida(numPersonaje, porcentajeVida)
	...
	interfazW:getChild(urlVida):setWidth(CEGUI.UDim(porcentajeVida*0.2,0))
end
